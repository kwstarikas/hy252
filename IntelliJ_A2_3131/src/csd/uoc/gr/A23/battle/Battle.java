...
public class Battle {
    ...
    public static void main(String[] args){
        ...
        HeistMember hm2 = new HeistMember("Tzitzikas", new Handgun(), false, getRandomVal(1, 2), getRandomVal(1, 5));
        HeistMember hm3 = new HeistMember("Athens", new Shotgun(), false, getRandomVal(1, 2), getRandomVal(1, 8));
        HeistMember hm4 = new HeistMember("Tyrana", new Submachine(), true, getRandomVal(1, 2), getRandomVal(1, 3));
        HeistMasterMind hmm = new HeistMasterMind("Loukas", new Rifle(), getRandomVal(1, 3), getRandomVal(1, 7),getRandomVal(1, 6));
        ...
        PoliceOfficer pi1 = new PoliceOfficer("pi1", new Rifle(), true, getRandomVal(1, 3),  getRandomVal(1, 3));
        PoliceInspector pi2 = new PoliceInspector("pi2", new Rifle(), true, getRandomVal(1, 3), getRandomVal(1, 3));
        PoliceInspector po5 = new PoliceInspector("po5", new Handgun(), false, getRandomVal(1, 2), getRandomVal(1, 3));
